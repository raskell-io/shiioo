...
fn create_router(state: AppState, schema: crate::graphql::ShiiooSchema) -> Router {
    Router::new()
        ...
        // Employee aliases (company metaphor — gradual migration)
        .route("/api/employees", get(agent_handlers::list_agents))
        .route("/api/employees", post(agent_handlers::create_agent))
        .route("/api/employees/{agent_id}", get(agent_handlers::get_agent))
        .route("/api/employees/{agent_id}", axum::routing::put(agent_handlers::update_agent))
        .route("/api/employees/{agent_id}", delete(agent_handlers::delete_agent))
        .route("/api/employees/{agent_id}/activate", post(agent_handlers::activate_agent))
        .route("/api/employees/{agent_id}/suspend", post(agent_handlers::suspend_agent))
        .route("/api/employees/{agent_id}/pause", post(agent_handlers::pause_agent))
        .route("/api/employees/{agent_id}/archive", post(agent_handlers::archive_agent))
        // Job title aliases (company metaphor — gradual migration)
        .route("/api/job-titles", get(agent_handlers::list_archetypes))
        .route("/api/job-titles", post(agent_handlers::create_archetype))
        .route("/api/job-titles/{archetype_id}", get(agent_handlers::get_archetype))
        .route("/api/job-titles/{archetype_id}", axum::routing::put(agent_handlers::update_archetype))
        .route("/api/job-titles/{archetype_id}", delete(agent_handlers::delete_archetype))
        // Employee runtime aliases (company metaphor — gradual migration)
        .route("/api/employees/{agent_id}/execute", post(runtime_handlers::execute_task))
        .route("/api/employees/{agent_id}/budget", get(runtime_handlers::get_agent_budget))
        .route("/api/employees/{agent_id}/delegate", post(runtime_handlers::delegate_task))
        .route("/api/employees/{agent_id}/supervisor", post(runtime_handlers::create_supervisor))
        .route("/api/employees/{agent_id}/supervision-events", get(runtime_handlers::get_supervision_events))
